...
class ActorCriticCnnTSPolicy(ActorCriticCnnPolicyDepth0):
    ...
    def forward(self, obs: th.Tensor, deterministic: bool = False) -> Tuple[th.Tensor, th.Tensor, th.Tensor]:
        ...
        if hash_obs in self.obs2leaves_dict:
            ...
            print(f'already inside leaves_observations.shape: {leaves_observations.shape}, rewards.shape: {rewards.shape}, first_action.shape: {first_action.shape} ')
            ...
            print(f'new leaves_observations.shape: {leaves_observations.shape}, rewards.shape: {rewards.shape}, first_action.shape: {first_action.shape} ')
