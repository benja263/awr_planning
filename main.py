...
def main():
    ...
    AWR_params = {"learning_rate": awr_def_lr, "gamma": 0.99, "n_steps": 5, "batch_size": 32, "normalize_advantage": True,
                  "ent_coef": 0.01, "gae_lambda": 0.95, "policy_gradient_steps": 1000, "value_gradient_steps": 200, "learning_starts": 5,}
